...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-)0q)h!tkb4e9+%5*5so2$b2l3#n8pvijvic4$!wy73%f+!ddbb')
...
# Usar el modelo User estándar de Django (comentado porque usamos el por defecto)
